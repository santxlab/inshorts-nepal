...
function getDefaultSources(): NewsSource[] {
  return [
    ...
    },
    {
      ...
      url: "https://en.nepalkhabar.com/feed/",
      language: "en",
      category: "all",
      isActive: true,
    },
    ...
    },
    {
      ...
      url: "https://www.nepallivetoday.com/feed/",
      language: "en",
      category: "all",
      isActive: true,
    },
    {
      ...
      url: "https://www.newbusinessage.com/feed/",
      language: "en",
      category: "business",
      isActive: true,
    },
    ...
    },
    {
      id: "en-naturekhabar",
      name: "Nature Khabar",
      url: "https://naturekhabar.com/en/feed/",
      language: "en",
      category: "all",
      isActive: true,
    },
    ...
    },
    {
      id: "ne-news24",
      name: "न्यूज २४ नेपाल",
      nameNe: "न्यूज २४ नेपाल",
      url: "https://www.news24nepal.tv/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
    ...
    },
    {
      ...
      name: "आर्थिक न्यूज",
      nameNe: "आर्थिक न्यूज",
      url: "https://aarthiknews.com/feed/",
      language: "ne",
      category: "business",
      isActive: true,
    },
    ...
    },
    {
      ...
      name: "मध्याह्न",
      nameNe: "मध्याह्न",
      url: "https://www.madhyahn.com/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
    {
      ...
      name: "खबरहब",
      nameNe: "खबरहब",
      url: "https://nepali.khabarhub.com/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
    ...
    },
    {
      ...
      name: "फरकधार",
      nameNe: "फरकधार",
      url: "https://www.farakdhar.com/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
    {
      ...
      name: "लोकान्तर",
      nameNe: "लोकान्तर",
      url: "https://www.lokantaronline.com/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
    ...
    },
    {
      ...
      name: "नेपाल आज",
      nameNe: "नेपाल आज",
      url: "https://www.nepalaaja.com/feed/",
      language: "ne",
      category: "all",
      isActive: true,
    },
